...
const MOCK_CONTACTS = [
  {
    id: 1,
    name: '園活 のぞみ',
    email: 'nozomi.enkatsu@example.com',
    message: '英語教室は週何回でしょうか。',
    createdAt: '2026/7/7 21:00',
  },
  {
    id: 2,
    name: '佐藤 恵',
    ...
    createdAt: '2026/7/2 21:00',
  },
  {
    id: 3,
    name: '高橋 美咲',
    email: 'misaki.takahashi@example.com',
    message: '英語教室の先生はネイティブの方でしょうか。',
    createdAt: '2026/6/28 12:00',
  },
  {
    id: 4,
    name: '高橋 美咲',
